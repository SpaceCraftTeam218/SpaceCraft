...
public class BlockSpaceCraft extends Block {

    public BlockSpaceCraft()
    {
        this(Material.rock);
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
        ...
        if (world.getTileEntity(x, y, z) instanceof TileEntitySpaceCraft)
        {
            int direction = 0;
            ...
            {
                ((TileEntitySpaceCraft) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
            }

            ((TileEntitySpaceCraft) world.getTileEntity(x, y, z)).setOrientation(direction);
        }
    }
